...
const TEAM_META = {
  ...
  110:{abbr:"BAL",name:"Baltimore Orioles",primary:"#DF4601",secondary:"#FCB826"},
  ...
  113:{abbr:"CIN",name:"Cincinnati Reds",primary:"#C6011F",secondary:"#BC9A6C"},
  ...
  137:{abbr:"SF",name:"San Francisco Giants",primary:"#FD5A1E",secondary:"#C4CED4"},
  ...
  141:{abbr:"TOR",name:"Toronto Blue Jays",primary:"#134A8E",secondary:"#E8291C"},
  142:{abbr:"MIN",name:"Minnesota Twins",primary:"#002B5C",secondary:"#D31145"},
  143:{abbr:"PHI",name:"Philadelphia Phillies",primary:"#E81828",secondary:"#284898"},
  ...
  147:{abbr:"NYY",name:"New York Yankees",primary:"#0C2340",secondary:"#C4CED3"},
